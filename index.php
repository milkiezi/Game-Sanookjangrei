...
include("login/connect.php");
 session_start(); 
 $data = mysqli_query($con,"SELECT * from games_data ") or die (mysqli_error());
...
<body>
    <header>
        ...
        <div class="full-height">
            <div class="row container-fluid pwhite">

                <div class="col-sm-5 ">
                    <img src="icon/game1.png" style="width: 75%;">
                </div>
                <div class="col-sm-7 ">
                    <h1>WELCOME! TO<br> GAME SANOOKJANGREI</h1>
                    <p>If you not Register yet please click at Register</p>
                    <a href="#gamediv"><button class="btn1 btn-1 " >continue</button></a>
                    <a href="signin.php" style="color: white; font-size: 20px; ">Register &rarr;</a>
                </div>
            </div>
        </div>
    </header>
    <!-- Another game -->
    <center>
        <div id="gamediv" class="container " style="margin-top:30px ">
            <div class="row ">
                <div class="col-sm-12 ">
